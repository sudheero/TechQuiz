...
{
    [Serializable]
    public class SPQuizDialog : IDialog<object>
    {
        ...
        public async Task StartAsync(IDialogContext context)
        {
            ...
            var heroCard = new ThumbnailCard
            {
                ...
                Images = new List<CardImage> { new CardImage("https://techquizbot.azurewebsites.net/images/SPIcon.png") },
        ...
        private async Task MessageReceivedStartQuestions(IDialogContext context, IAwaitable<object> result)
        {
            ...
            else
            {
                ...
                var heroCard = new ThumbnailCard
                {
                    Title = "SharePoint Quiz is completed",
        ...
        private async Task MessageReceivedCorrection(IDialogContext context, IAwaitable<IMessageActivity> result)
        {
            ...
            else
            {
                ...
                Utility.UpdateResults(activity, "SharePoint", correctAnswers, quiz.Count);
